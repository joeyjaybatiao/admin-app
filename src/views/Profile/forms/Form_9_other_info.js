...
import { UpdateSkill, UpdateRecognition, UpdateMembership, SaveInfoUpdates, } from '../redux/actions';

const Form_9_other_info = (props) => {
    return (
        <>
            <Col id="form-container" className="order-xl-1" xl="8">
                <Card className="bg-secondary shadow">
                    ...
                    <CardBody>
                        <Form style={{ borderBottom: "1px solid rgba(0, 0, 0, 0.3)", marginBottom: "10px", paddingBottom: "10px" }}>
                            ...
                            <div className="pl-lg-4">
                                {
                                    props.pValues.pds.others.skillsHobbies.map((data, i) => {
                                        ...
                                        return (
                                            <Row style={{ borderBottom: "1px solid rgba(0, 0, 0, 0.1)", marginBottom: "10px", paddingBottom: "10px" }}>
                                                <Col lg="10">
                                                    <LabelInput
                                                        label={"Name"}
                                                        prop={"pds.others.skillsHobbies." + i + ".name"}
                                                        value={data.name}
                                                        type="text"
                                                        req={1}
                                                        placeholder=""
                        ...
                        <Form style={{ borderBottom: "1px solid rgba(0, 0, 0, 0.3)", marginBottom: "10px", paddingBottom: "10px" }}>
                            ...
                            <h6 className="heading-small text-muted mb-4">
                                Non-Academic Distictions/Recognitions
                                <Col className="text-right" xs="12">
                                    <Button
                                        color="primary"
                                        onClick={(e) => props.UpdateRecognition()}
                                        size="sm"
                                    >
                                        Add
                                    </Button>
                            ...
                            <div className="pl-lg-4">
                                {
                                    props.pValues.pds.others.recognition.map((data, i) => {
                                        ...
                                        return (
                                            <Row style={{ borderBottom: "1px solid rgba(0, 0, 0, 0.1)", marginBottom: "10px", paddingBottom: "10px" }}>
                                                <Col lg="10">
                                                    <LabelInput
                                                        label={"Name"}
                                                        prop={"pds.others.recognition." + i + ".name"}
                                                        value={data.name}
                                                        type="text"
                                                        req={1}
                                                        placeholder=""
                                                ...
                                                <Col lg="2">
                                                    <Button
                                                        color="primary"
                                                        onClick={(e) => props.UpdateRecognition('-', i)}
                                                        size="sm"
                                                    >
                                                        Remove
                                                    </Button>
                        ...
                        <Form style={{ borderBottom: "1px solid rgba(0, 0, 0, 0.3)", marginBottom: "10px", paddingBottom: "10px" }}>
                            ...
                            <h6 className="heading-small text-muted mb-4">
                                ...
                                <Col className="text-right" xs="12">
                                    <Button
                                        color="primary"
                                        onClick={(e) => props.UpdateMembership()}
                                        size="sm"
                                    >
                                        Add
                                    </Button>
                            ...
                            <div className="pl-lg-4">
                                {
                                    props.pValues.pds.others.membership.map((data, i) => {
                                        ...
                                        return (
                                            <Row style={{ borderBottom: "1px solid rgba(0, 0, 0, 0.1)", marginBottom: "10px", paddingBottom: "10px" }}>
                                                <Col lg="10">
                                                    <LabelInput
                                                        label={"Name"}
                                                        prop={"pds.others.membership." + i + ".name"}
                                                        value={data.name}
                                                        type="text"
                                                        req={1}
                                                        placeholder=""
                                                ...
                                                <Col lg="2">
                                                    <Button
                                                        color="primary"
                                                        onClick={(e) => props.UpdateMembership('-', i)}
                                                        size="sm"
                                                    >
                                                        Remove
                                                    </Button>
